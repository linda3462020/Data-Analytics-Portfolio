...
### glm2 is the best model of the three of them because glm2 has the lowest MSE among the three. Lower MSE value indicates the smaller average distance between the actual value and the prediction value.
```
...
```{r}
# which model is best for predicting median home values?  
### glm2 is still the best model of the three of them because glm2 has the lowest MSE among the three. There are the same reason : Lower MSE value indicates the smaller average distance between the actual value and the prediction value.
```